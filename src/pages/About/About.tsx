    ...
    <div className="container mt-5 mb-5 text-center">
      ...
      <p>
        ...
        <span className="ml-1 mr-2">
          <img
            src="../assets/images/argentine-flag.png"
            width="50"
            height="30"
            alt=""
          />
        ...
        <span>
          <img
            src="../assets/images/italy-flag.png"
            width="50"
            height="30"
            alt=""
          />
      ...
      <div className="mt-2">
        <span className="mr-1">{consts.ABOUT.YOU_CAN_FIND_ME}:</span>
        <span>
          <a
            href="https://twitter.com/cripto_lucas"
            target="_blank"
            rel="noreferrer"
